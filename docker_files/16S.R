...
#dadaFs <- dada(derep_forward, NULL, selfConsist=TRUE, multithread=TRUE)
#dadaRs <- dada(derep_reverse, NULL, selfConsist=TRUE, multithread=TRUE)
...
db <- args[3] # "/mnt/efs/databases/Silva/silva_nr99_v138.1_train_set.fa.gz"

#Assign taxonomy
taxa <- assignTaxonomy(seqtab.nochim, db, multithread=TRUE, tryRC=TRUE)
