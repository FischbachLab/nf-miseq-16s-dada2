...
timem Rscript 16S.R ${LOCAL_OUTPUT} ${INPUT_DIR} ${DB}
python fix_summary.py ${LOCAL_OUTPUT}/Sample_stats.tsv ${LOCAL_OUTPUT}/ASVs_taxonomy_dada2.tsv ${LOCAL_OUTPUT}/ASVs_counts.tsv
